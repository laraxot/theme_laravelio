                ...
                <div class="block mb-4">
                    <div class="border-b border-gray-200">
                        <nav class="-mb-px flex dashboard-nav">
                            <a href="#" @click="tab = 'notifications'" :class="{ 'active': tab === 'notifications' }"
                                class="whitespace-nowrap py-4 px-1 border-b-2 border-transparent font-medium text-sm leading-5 text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300">
                                Notifications
