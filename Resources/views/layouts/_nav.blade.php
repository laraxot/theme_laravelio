        ...
        <div class="block bg-white 2xl:-mx-10">
            <div class="lg:px-4 lg:flex">
                <div class="block lg:flex lg:items-center lg:flex-shrink-0">
                    ...
                    <div class="mt-2 border-b lg:block lg:mt-0 lg:border-0" x-cloak
                        ...
                        <ul class="flex flex-col px-4 mb-2 gap-y-2 lg:flex-row lg:mb-0 lg:gap-6">
                            ...
                            <li class="rounded lg:mb-0 lg:hover:bg-gray-100">
                                <div @click.away="chat = false" class="relative">
                                    ...
                                    <div x-show="chat" x-cloak>
                                        <ul
                                            class="ml-4 lg:absolute lg:flex lg:flex-col lg:ml-0 lg:mt-2 lg:w-36 lg:rounded-md lg:shadow-lg lg:z-50 lg:bg-white">
                                            <li class="my-4 lg:hover:bg-gray-100 lg:my-0">
                                                <a href="https://discord.gg/KxwQuKb"
                                                    class="inline-block w-full lg:px-4 lg:py-3">Discord</a>
                                            </li>

                                            <li class="mb-4 lg:hover:bg-gray-100 lg:mb-0">
                                                <a href="https://larachat.co"
                                                    class="inline-block w-full lg:px-4 lg:py-3">Larachat</a>
                                            </li>

                                            <li class="hover:bg-gray-100">
                                                <a href="https://web.libera.chat/?nick=laravelnewbie&channels=#laravel"
                                                    class="inline-block w-full lg:px-4 lg:py-3">IRC</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <li class="rounded lg:mb-0 lg:hover:bg-gray-100">
                                <div @click.away="community = false" class="relative"
                                        ...
                                        <ul
                                            ...
                                            <li class="my-4 lg:hover:bg-gray-100 lg:my-0">
                                                <a href="https://github.com/laravelio"
                                                    class="inline-block w-full lg:px-4 lg:py-3">Github</a>
                                            </li>

                                            <li class="mb-4 lg:hover:bg-gray-100 lg:mb-0">
                                                <a href="https://twitter.com/laravelio"
                                                    class="inline-block w-full lg:px-4 lg:py-3">Twitter</a>
                                            </li>

                                            <li class="mb-4 lg:hover:bg-gray-100 lg:mb-0">
                                                <a href="https://laravel.com"
                                                    class="inline-block w-full lg:px-4 lg:py-3">Laravel</a>
                                            </li>

                                            <li class="mb-4 lg:hover:bg-gray-100 lg:mb-0">
                                                <a href="https://laracasts.com"
                                                    class="inline-block w-full lg:px-4 lg:py-3">Laracasts</a>
                                            </li>

                                            <li class="mb-4 lg:hover:bg-gray-100 lg:mb-0">
                                                <a href="https://laravel-news.com"
                                                    class="inline-block w-full lg:px-4 lg:py-3">Laravel News</a>
                                            </li>

                                            <li class="mb-4 lg:hover:bg-gray-100 lg:mb-0">
                                                <a href="https://laravelevents.com"
                                                    class="inline-block w-full lg:px-4 lg:py-3">Laravel Events</a>
                                            </li>

                                            <li class="mb-4 lg:hover:bg-gray-100 lg:mb-0">
                                                <a href="https://www.laravelpodcast.com"
                                                    class="inline-block w-full lg:px-4 lg:py-3">Podcast</a>
                                            </li>

                                            <li class="hover:bg-gray-100">
                                                <a href="https://ecosystem.laravel.io"
                                                    class="inline-block w-full lg:px-4 lg:py-3">Ecosystem</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class="w-full block gap-x-4 lg:flex lg:items-center lg:justify-end">
                    <div class="lg:block" x-cloak :class="{ 'block': search, 'hidden': !search }"
                        @click.away="search = false">
                        @include('pub_theme::_partials._search')
                    </div>
